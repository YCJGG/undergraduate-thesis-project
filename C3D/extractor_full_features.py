...
def run_test():
  ...
  for step in xrange(all_steps):
    ...
    for i in xrange(test_images.shape[0]):
      ...
      Feature = sess.run(featues,feed_dict = {images_placeholder: test_image})
      #print(Feature.shape)
    ...
    label = test_labels[0]
    np.save('./full_features/'+str(step)+'.npy',f)
    file.write('./full_features/'+str(step)+'.npy'+' '+str(label)+'\n')
